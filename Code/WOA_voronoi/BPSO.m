%binary PSO M. A. Khanesar
% Khanesar, M.A., Teshnehlab, M. and Shoorehdeli, M.A., 2007, June. A novel
% binary particle swarm optimization. In 2007 Mediterranean conference on control 
...
for tt=1:10
    ...
    for i=1:popsize
        ...
        fx(i)=feval(ff,xn); % fx == 1 x popsize
    end
