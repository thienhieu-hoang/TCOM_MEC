%----------------------------------------------------------------------------
% apply only BWOA algorithm to solve UL pb, i.e. without any conditions. 
%----------------------------------------------------------------------------
...
function [leader_score_bwoa, leader_pos_bwoa, leader_pos_woa, conver_curve, conver_curve_woa, no_WOA_run, time] = BWOA(functionName, doTol, noSearchAgents, noUsers, noSubcs, noBSs, r_m, r_nm, maxIter, fobj_bwoa, lb_woa, ub_woa, fobj_woa, theta, eta, hArray, n0, p_min, p_max, nu, Adetermined)
