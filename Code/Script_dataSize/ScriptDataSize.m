...
noRealizations = 10; %200

D_n_sample = 0.2:0.2:1; % x1e6

doTol = 1; 

po_ALCA = zeros(length(D_n_sample), noRealizations); 
su_ALCA = zeros(length(D_n_sample), noRealizations); 

po_ARJOA = zeros(length(D_n_sample), noRealizations); 
su_ARJOA = zeros(length(D_n_sample), noRealizations); 

po_WOA_BWOA = zeros(length(D_n_sample), noRealizations); 
su_WOA_BWOA = zeros(length(D_n_sample), noRealizations); 

po_IOJOA = zeros(length(D_n_sample), noRealizations); 
su_IOJOA = zeros(length(D_n_sample), noRealizations); 

po_OFDMA = zeros(length(D_n_sample), noRealizations);
su_OFDMA = zeros(length(D_n_sample), noRealizations);

po_PSO_BWOA = zeros(length(D_n_sample), noRealizations);
su_PSO_BWOA = zeros(length(D_n_sample), noRealizations);

po_IWOA_BWOA = zeros(length(D_n_sample), noRealizations);
su_IWOA_BWOA = zeros(length(D_n_sample), noRealizations);

xt = cell(1, length(D_n_sample)); 
